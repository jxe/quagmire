...
public struct Block: Identifiable, Equatable, Sendable {
    ...
    /// Opaque host-owned annotations that travel with this block. Quagmire
    /// compares and snapshots them, but never interprets their keys or values.
    /// Hosts should namespace keys they persist or project into a document.
